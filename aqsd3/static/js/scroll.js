        ...
        d3.csv(courl).then(data3 => {
            d3.csv(sourl).then(data4 => {
                d3.csv(nourl).then(data5 => {        
                    ...
                    var pollutants = [
                        {pollutant: "81102", color: "#DC0000"},
                        {pollutant: "42101", color: "green"},
                        {pollutant: "44201", color: "blue"},
                        {pollutant: "42401", color: "#cc5500"},
                        {pollutant: "42602", color: "yellow"},
                        {pollutant: "all", color: "purple"}
                    ];
